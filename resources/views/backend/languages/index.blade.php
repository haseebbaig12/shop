    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Language</h6>
        ...
        <div class="col-lg-6 col-5 text-right">
          <a href="{{route ('language.create')}}" class="btn btn-sm btn-neutral">Add New</a>
            ...
            <tbody class="list">
              ...
              <tr>
                  ...
                  <td class="budget" >
                    ...
                    <a class="dropdown-item" href="{{route('language.edit',$languages['id'])}}">
                      {{$languages['name']}}</td>
                    </a>
                  <td class="budget">
                    {{$languages['sku']}}
