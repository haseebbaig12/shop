    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Attribute</h6>
        ...
        <div class="col-lg-6 col-5 text-right">
          <a href="{{route ('attribute.create')}}" class="btn btn-sm btn-neutral">Add New</a>
                ...
                <td class="text-right">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                      ...
                      <a class="dropdown-item" href="{{route('attribute.edit',$attributes->id)}}">
