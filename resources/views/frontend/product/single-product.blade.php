            ...
            <div class="row">
                <div class="col-md-5 mb-5 mb-md-0">
                    ...
                    <div class="thumb-gallery-wrapper">
                        <div class="thumb-gallery-detail owl-carousel owl-theme manual nav-inside nav-style-1 nav-dark mb-3">
                            <div>
                                <img alt="" class="img-fluid" src="{{asset('frontend/img/products/product-grey-7.jpg')}}" data-zoom-image="img/products/product-grey-7.jpg">
                            </div>
                            <div>
                                <img alt="" class="img-fluid" src="{{asset('frontend/img/products/product-grey-7-2.jpg')}}" data-zoom-image="img/products/product-grey-7-2.jpg">
                            </div>
                            <div>
                                <img alt="" class="img-fluid" src="{{asset('frontend/img/products/product-grey-7-3.jpg')}}" data-zoom-image="img/products/product-grey-7-3.jpg">
                            </div>
                            <div>
                                <img alt="" class="img-fluid" src="{{asset('frontend/img/products/product-grey-8.jpg')}}" data-zoom-image="img/products/product-grey-8.jpg">
                            </div>
                            <div>
                                <img alt="" class="img-fluid" src="{{asset('frontend/img/products/product-grey-6.jpg')}}" data-zoom-image="img/products/product-grey-6.jpg">
                            </div>
                            <div>
                                <img alt="" class="img-fluid" src="{{asset('frontend/img/products/product-grey-5.jpg')}}" data-zoom-image="img/products/product-grey-5.jpg">
                            </div>
                        </div>
                        <div class="thumb-gallery-thumbs owl-carousel owl-theme manual thumb-gallery-thumbs">
                            ...
                            <div class="cur-pointer">
                                <img alt="" class="img-fluid" src="{{asset('frontend/img/products/product-grey-7-2.jpg')}}">
                            </div>
                            <div class="cur-pointer">
                ...
                <div class="col-md-7">
                    ...
                    <div class="summary entry-summary position-relative">
                        ...
                        <li class="mb-0">SKU: <strong class="text-color-dark">{{$product->slug}}</strong></li>
                        </ul>
