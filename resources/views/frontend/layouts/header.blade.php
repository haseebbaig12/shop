        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav m-auto">
                ...
                <li class="nav-item active btn">
                    <a class="nav-link" href="{{ route('schedule.index') }}">Class Schedule </a>
                </li>

                <li class="nav-item active btn">
                    <a class="nav-link" href="{{ route('subscription.index') }}">Subscribe Now </a>
                </li>
                </li>
                <li class="nav-item active btn">
...
{{--                                <button class="dropdown-item">{{$languages->name}}</button>--}}
{{--                            </form>--}}
